...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES 
           WHERE TABLE_TYPE='BASE TABLE' AND TABLE_NAME='HAMS_DayTotal') 
	DROP TABLE dbo.HAMS_DayTotal
GO


CREATE TABLE [dbo].[HAMS_DayTotal](
	...
	[DataType] [varchar](20) NULL DEFAULT ((0)),
	[CreateTime] [datetime] NULL,
 CONSTRAINT [HAMS_DayTotal_PK] PRIMARY KEY CLUSTERED 
(
